...
if __name__ == '__main__':
    ...
    select_config = '#01 ACMSIMC PMSM EEMF'
    ...
    for i in range(0, NUMBER_OF_RUNS):
        ...
        raw_config_dicts[select_config+f' - Variant Speed P {i:03d}']['SPEED_LOOP_PID_PROPORTIONAL_GAIN'] = 0.5+1*i
        raw_config_dicts[select_config+f' - Variant Speed P {i:03d}']['DATA_FILE_NAME'] = f"\"pmsm_eemf_VSP{i:03d}.dat\""

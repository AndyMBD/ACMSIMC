...
void write_header_to_file(FILE *fw){
    ...
    fprintf(fw, "x0(id)[A],x1(iq)[A],x2(speed)[rpm],x3(position)[rad],ud[V],uq[V],IS_C(0),CTRL.ual,ACM.ual,ACM.theta_d,DIST_AL,COMM.KE,COMM.Js\n");
        ...
        // if(CTRL.timebase>20)
        {
            if(++j == DOWN_SAMPLE)
            {
                ...
                fprintf(fw, "%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g,%g\n",
                        ...
                        IS_C(0), CTRL.ual, ACM.ual, ACM.theta_d, DIST_AL, COMM.KE, COMM.Js
                        );
            }
        }
